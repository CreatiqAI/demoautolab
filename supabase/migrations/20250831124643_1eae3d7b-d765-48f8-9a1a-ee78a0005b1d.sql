...
INSERT INTO public.products (
  sku, name, slug, description, brand, model, year_from, year_to, 
  category_id, price_regular, price_merchant, stock_on_hand, keywords, active
) VALUES 
-- Navigation Systems
('NAV-001', 'AUDI A1 2008-2012 9 inch Android Navigation System', 'audi-a1-android-nav-system', 
 ...
 'AutoTech Pro', 'A1', 2008, 2012, 
 (SELECT id FROM categories WHERE slug = 'electrical'), 
 350.00, 280.00, 15, 
 ARRAY['navigation', 'android', 'gps', 'audi', 'multimedia']),
...
('NAV-002', 'Honda Civic 2016-2021 10 inch CarPlay Android Auto System', 'honda-civic-carplay-system',
 ...
 'MediaMax', 'Civic', 2016, 2021,
 (SELECT id FROM categories WHERE slug = 'electrical'),
 420.00, 350.00, 8,
 ARRAY['carplay', 'android auto', 'honda', 'infotainment']),
...
('ENG-003', 'K&N High Flow Air Filter - Universal', 'kn-high-flow-air-filter',
 ...
 'K&N Performance', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'engine-components'),
 89.90, 75.00, 45,
 ARRAY['air filter', 'performance', 'kn', 'universal']),
...
('ENG-004', 'Bosch Platinum Spark Plugs Set of 4', 'bosch-platinum-spark-plugs',
 ...
 'Bosch', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'engine-components'),
 120.00, 95.00, 60,
 ARRAY['spark plugs', 'platinum', 'bosch', 'engine']),
...
('BRK-002', 'Brembo High Performance Brake Discs - Rear', 'brembo-brake-discs-rear',
 ...
 'Brembo', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'brake-system'),
 280.00, 230.00, 12,
 ARRAY['brake discs', 'brembo', 'rear', 'performance']),
...
('BRK-003', 'EBC RedStuff Ceramic Brake Pads - Front', 'ebc-redstuff-ceramic-pads',
 ...
 'EBC Brakes', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'brake-system'),
 195.00, 165.00, 28,
 ARRAY['brake pads', 'ceramic', 'ebc', 'performance']),
...
('SUS-004', 'Bilstein B4 Shock Absorber Set', 'bilstein-b4-shock-set',
 ...
 'Bilstein', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'suspension'),
 450.00, 380.00, 10,
 ARRAY['bilstein', 'shock absorber', 'oe replacement']),
...
('SUS-005', 'Eibach Pro-Kit Lowering Springs', 'eibach-pro-kit-springs',
 ...
 'Eibach', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'suspension'),
 320.00, 270.00, 16,
 ARRAY['lowering springs', 'eibach', 'performance', 'suspension']),
...
('BDY-001', 'LED Headlight Conversion Kit H4', 'led-headlight-h4-kit',
 ...
 'LightMax Pro', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'body-parts'),
 150.00, 125.00, 35,
 ARRAY['led headlight', 'h4', 'conversion', 'lighting']),
...
('BDY-002', 'Carbon Fiber Side Mirror Covers', 'carbon-fiber-mirror-covers',
 ...
 'CarbonTech', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'body-parts'),
 80.00, 65.00, 22,
 ARRAY['carbon fiber', 'mirror covers', 'exterior']),
...
('INT-001', 'Racing Bucket Seat Pair with Harness', 'racing-bucket-seats',
 ...
 'SeatPro Racing', 'Universal', NULL, NULL,
 (SELECT id FROM categories WHERE slug = 'interior'),
 850.00, 720.00, 6,
 ARRAY['racing seats', 'bucket', 'harness', 'fia']);
