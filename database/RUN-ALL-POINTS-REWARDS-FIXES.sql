-- ============================================================
-- COMPLETE POINTS & REWARDS FIX
-- Run this file to fix all Points & Rewards issues
-- ============================================================

-- This file consolidates all the fixes needed for:
-- 1. RLS policies for reward_items
-- 2. RLS policies for customer_points_ledger
-- 3. RLS policies for point_redemptions
-- 4. Storage bucket setup for reward images
