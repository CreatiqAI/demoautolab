-- ============================================================================
-- AUTOLAB B2B PLATFORM - COMPLETE DATABASE MIGRATION (FIXED FOR YOUR SCHEMA)
...
--
-- NOTE: This version is fixed for schemas with customer_profiles & admin_profiles
-- ============================================================================
...
CREATE POLICY "Admins can manage manufacturers" ON manufacturers
  FOR ALL
  USING (true); -- Permissive for now since admins don't use auth.uid()
...
-- ============================================================================
-- PHASE 1.2: ADD MANUFACTURER FIELDS TO PRODUCTS
-- ============================================================================
...
CREATE POLICY "Admins can manage all secondhand listings" ON secondhand_listings
  FOR ALL
  USING (true); -- Permissive for admins since they don't use auth.uid()
...
BEGIN
  ...
  RAISE NOTICE '  2. Test features in your app';
  RAISE NOTICE '  3. Verify Panel tier changes in MerchantConsole';
  RAISE NOTICE '=========================================';
END $$;
