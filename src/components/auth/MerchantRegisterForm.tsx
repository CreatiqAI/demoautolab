    ...
    <>
            ...
            <div className="mb-8">
              <h2 className="font-heading font-bold uppercase tracking-tight text-3xl text-gray-900 mb-2">
                {step === 1 ? 'Merchant Sign-Up' : 'Complete Registration'}
              </h2>
              <p className="text-gray-500 text-sm">
                {step === 1
                  ? 'Enter the salesman code from your AutoLab sales rep to begin.'
            ...
            {step === 1 && (
              <div className="mt-4 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                ...
                <p className="text-xs text-blue-700">
                  Contact our sales team to get your unique code (e.g., AHMAD2K9L) — you'll need it to start your merchant registration.
                </p>
              </div>
            )}
    </>
