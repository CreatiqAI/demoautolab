...
const About = () => {
    ...
    return (
        <div className="bg-background font-sans">
            ...
            {/* Hero Section */}
            <section className="relative py-16 sm:py-24 md:py-32 bg-gray-900 overflow-hidden">
                ...
                <div className="container mx-auto px-3 sm:px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <motion.h1 variants={fadeInUp} className="text-3xl sm:text-5xl md:text-7xl font-heading font-bold text-white mb-4 sm:mb-8 italic">
                            DRIVING <span className="text-lime-500">EXCELLENCE</span>
                        </motion.h1>
                        <motion.p variants={fadeInUp} className="text-base sm:text-xl text-gray-300 leading-relaxed font-light">
            ...
            <section className="py-12 sm:py-16 md:py-24 bg-white">
                <div className="container mx-auto px-3 sm:px-6">
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                        ...
                        >
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4 sm:mb-6 italic">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
                        {[
                            ...
                            >
                                ...
                                <div className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-white mb-2">{stat.number}</div>
            ...
            <section className="py-12 sm:py-16 md:py-24 bg-gray-50">
                <div className="container mx-auto px-3 sm:px-6">
                    <div className="text-center mb-8 sm:mb-12 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4 italic">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
                            >
